    ...
    <x-modal.modal name="{{ $modal }}">
        <x-slot name="content">
            <div class="mt-3 text-center sm:mt-0 sm:text-left">
                ...
                @isset($module)
                <div class="mt-2">
                    <p class="text-sm text-gray-500">Are you sure you want to deactivate <span class="font-semibold">{{ $module['display_name'] }}</span> module? It'll not be accessible to the user.</p>
                </div>
                @endisset
            </div>
        </x-slot>
